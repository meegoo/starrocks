...
SchemaScanner::ColumnDesc SchemaLoadsScanner::_s_tbls_columns[] = {
        ...
        {"RUNTIME_DETAILS", TypeDescriptor::from_logical_type(TYPE_JSON), sizeof(StringValue), true},
        ...
        {"PROPERTIES", TypeDescriptor::from_logical_type(TYPE_JSON), sizeof(StringValue), true},
