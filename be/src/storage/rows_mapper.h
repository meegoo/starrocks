...
// Get the row count from a rows mapper file for a specific subtask.
StatusOr<uint64_t> lake_rows_mapper_row_count(int64_t tablet_id, int64_t txn_id, int32_t subtask_id);
