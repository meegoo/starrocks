...
// This should be called after light_publish completes successfully or when cleaning up
// the tablet parallel compaction state.
...
// - TabletParallelCompactionManager::cleanup_tablet() also cleans up files as a safety net.
