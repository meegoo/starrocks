...
void CompactionScheduler::compact(::google::protobuf::RpcController* controller, const CompactRequest* request,
    ...
    LOG(INFO) << "Receive compaction request. txn_id: " << request->txn_id() << ", table_id: " << request->table_id()
              << ", partition_id: " << request->partition_id() << ", tablet_ids size: " << request->tablet_ids_size();
