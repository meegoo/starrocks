...
public class LakeCompactionMaxParallelTest extends StarRocksTestBase {
    ...
    // Only show when value is not default (3)
    // ===========================================
    ...
    public void testShowCreateTableWithNonDefaultLakeCompactionMaxParallel() throws Exception {
        ...
        Assertions.assertTrue(createTableSql.contains("\"lake_compaction_max_parallel\" = \"5\""),
    ...
    public void testShowCreateTableWithDefaultLakeCompactionMaxParallel() throws Exception {
        ...
        Assertions.assertFalse(createTableSql.contains("lake_compaction_max_parallel"),
                "SHOW CREATE TABLE should NOT show lake_compaction_max_parallel when it is default (3): "
                        + createTableSql);
    }
